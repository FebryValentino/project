...
class Autentifikasi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('autentifikasi/login-2');
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-message" role="alert">Pengguna Belum Teraktivasi!!</div>');
                redirect('autentifikasi');
            }
        } else {
    ...
    public function registrasi()
    {
        ...
        $this->form_validation->set_rules('email', 'Alamat Email', 'required|trim|valid_email|is_unique[user.email]', [
            ...
            'required' => 'Masukan alamat email !!',
            'is_unique' => 'Alamat email sudah teregistrasi !!'
        ]);
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/aute_header', $data);
            $this->load->view('autentifikasi/register-2');
            $this->load->view('templates/aute_footer');
        } else {
